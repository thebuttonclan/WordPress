...
//    add_action('pl_platform_ui_body_your_products', array( $this, 'your_products'), 10, 2);
  ...
  function config(){
    ...
    $d = array(
      'default'   => array(
      'title'     => __( 'Extend PageLines', 'pl-platform' ),
      )
    );
  ...
  function nav_schema(){
    ...
    $nav_schema['extensions'] = array(
            ...
            'favs'    =>array(
              'name'      => __( 'My Favourites', 'pl-platform' ),
              'title'     => __( 'Favourite Addons', 'pl-platform' ),
            ),
            'favs_install'    =>array(
              'name'      => __( '<i class="pl-icon pl-icon-download"></i> Install All Favourites', 'pl-platform' ),
              'title'     => __( 'Favorite Addons', 'pl-platform' ),
            ),
            'multi_install'    =>array(
              'name'      => __( '<i class="pl-icon pl-icon-download"></i> Install <span class="install-text"></span>', 'pl-platform' ),
              'title'     => __( 'Multiple Addons', 'pl-platform' ),
            ),
          );
  ...
  function is_product_free( $product ) {
    ...
    foreach( (array) $product->categories as $cat ) {
      if( isset( $cat->slug  ) && $cat->slug == 'free' )
        return true;
    }
  }
